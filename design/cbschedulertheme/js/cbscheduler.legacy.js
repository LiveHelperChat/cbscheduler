        ...
        setTimeout( function() {
            if (document.querySelector(".modal-backdrop") === null) {
                ...
                if (cbSchedulerLoaded === false) {
                    ...
                    // Insert CSS
                    var srcCSS = WWW_DIR_LHC_WEBPACK_ADMIN.replace('/design/defaulttheme/js/admin/dist/','') + '/extension/cbscheduler/design/cbschedulertheme/css/cbscheduler.css?v=10';
                    ...
                    // Insert JS
                    var src = WWW_DIR_LHC_WEBPACK_ADMIN.replace('/design/defaulttheme/js/admin/dist/','') + '/extension/cbscheduler/design/cbschedulertheme/js/scheduler/dist/react.cbscheduler.app.js?v=10';
