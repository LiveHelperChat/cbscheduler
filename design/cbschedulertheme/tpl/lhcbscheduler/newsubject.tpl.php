<h1><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('module/cbscheduler','New subject');?></h1>

<?php if (isset($errors)) : ?>
    <?php include(erLhcoreClassDesign::designtpl('lhkernel/validation_error.tpl.php'));?>
<?php endif; ?>

<form action="<?php echo erLhcoreClassDesign::baseurl('cbscheduler/newsubject')?>" method="post">

    <?php include(erLhcoreClassDesign::designtpl('lhcbscheduler/parts/form_subject.tpl.php'));?>
