...
$tpl = erLhcoreClassTemplate::getInstance('lhcbscheduler/subjects.tpl.php');
...
$pages->items_total = erLhcoreClassModelCBSchedulerSubject::getCount($filterParams['filter']);
...
$filterParams['input_form']->form_action = erLhcoreClassDesign::baseurl('cbscheduler/subjects');
...
$Result['path'] = array (
    ...
    array('title' => erTranslationClassLhTranslation::getInstance()->getTranslation('module/cbscheduler','Subjects'))
);
