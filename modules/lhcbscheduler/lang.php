...
$translations = array(
    "fields" => [
        ...
        "verification_failed" => erTranslationClassLhTranslation::getInstance()->getTranslation('module/cbscheduler','I would love some assistance setting up a callback or connecting with a Support agent.'),
